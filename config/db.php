<?php 
    ...
    if(isset($_POST['mpesaPayment'])){
        ...
        $mpesa_secret = "LZtrAyR0OZi08JyQ";
        $mpesa_key = "Ll0oT9j55HCcLSgoIG5vmj9F8EoLEHiM";
        ...
        // $passwordd = base64_encode($mpesa_shortcode . $mpesa_passkey . $timedate);

        // $url = 'https://sandbox.safaricom.co.ke/mpesa/b2c/v1/paymentrequest';
  
        // $curl = curl_init();
        // curl_setopt($curl, CURLOPT_URL, $url);
        // curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type:application/json','Authorization:Bearer'.$curl_response)); //setting custom header
